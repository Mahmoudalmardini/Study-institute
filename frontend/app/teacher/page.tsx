        ...
        <div className="space-y-4 sm:space-y-6">
          <div className="grid grid-cols-1 gap-4 sm:gap-6 sm:grid-cols-2">
            ...
            <button
              ...
              className={`bg-white overflow-hidden rounded-xl hover-lift p-6 sm:p-7 border-2 border-teal-100 hover:border-teal-300 group text-start ${mounted ? 'animate-slide-up stagger-1' : 'opacity-0'}`}
            >
