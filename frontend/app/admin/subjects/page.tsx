              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">
                    {t.subjects?.subjectName || 'Subject Name'}
                  </label>
                  <input
                    type="text"
                    value={formData.name}
                ...
                <div className="md:col-span-2">
                  <label className="block text-sm font-semibold text-gray-700 mb-2">
                    {t.subjects?.description || 'Description'}
                  </label>
                  <textarea
                ...
                <div className="md:col-span-2">
                  ...
                  <select
                    ...
                    required
                  >
                    <option value="">{t.subjects?.selectClass || 'Select Class'}</option>
                    {(classes || []).map((cls) => (
                      <option key={cls.id} value={cls.id}>
                        {cls.name} - {cls.grade}
                      </option>
