        ...
        <div className="space-y-4 sm:space-y-6">
          <div className="grid grid-cols-1 gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <button
              ...
              className={`bg-white overflow-hidden rounded-xl hover-lift p-6 sm:p-7 border-2 border-blue-100 hover:border-blue-300 text-start group ${mounted ? 'animate-slide-up stagger-6' : 'opacity-0'}`}
            >
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-2">{t.admin.points}</h3>
                  <p className="text-sm text-gray-600">{t.admin.pointsDesc}</p>
                </div>
            ...
            <button
              ...
              className={`bg-white overflow-hidden rounded-xl hover-lift p-6 sm:p-7 border-2 border-yellow-100 hover:border-yellow-300 text-start group ${mounted ? 'animate-slide-up stagger-7' : 'opacity-0'}`}
            >
              <div className="flex items-start justify-between">
                <div className="flex-1">
