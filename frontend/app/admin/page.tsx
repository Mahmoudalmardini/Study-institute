      ...
      <main className="max-w-7xl mx-auto py-6 sm:py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-4 sm:space-y-6">
          <div className="grid grid-cols-1 gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            {/* Students Card */}
            <div className={`bg-white overflow-hidden rounded-xl hover-lift p-6 sm:p-7 border-2 border-emerald-100 hover:border-emerald-300 group ${mounted ? 'animate-slide-up stagger-2' : 'opacity-0'}`}>
            ...
            {/* Teachers Card */}
            <div className={`bg-white overflow-hidden rounded-xl hover-lift p-6 sm:p-7 border-2 border-purple-100 hover:border-purple-300 group ${mounted ? 'animate-slide-up stagger-3' : 'opacity-0'}`}>
