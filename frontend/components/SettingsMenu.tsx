...
export default function SettingsMenu({ onLogout }: SettingsMenuProps) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 rtl:right-auto rtl:left-0 z-50 mt-2 w-56 origin-top-right rounded-xl bg-white shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none animate-scale-in">
          <div className="py-1">
            {/* Language Section */}
